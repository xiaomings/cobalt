...
int SbMediaGetVideoBufferBudget(SbMediaVideoCodec codec,
  ...
  static const std::optional<int> overlayed_video_buffer_budget =
  ...
  if (overlayed_video_buffer_budget) {
    return std::min(video_buffer_budget, overlayed_video_buffer_budget.value());
  }
